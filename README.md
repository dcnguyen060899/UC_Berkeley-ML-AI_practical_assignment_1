...
2. Given these observation, this would craft an effective marketing strategies that appear in the data. For example, younger customer between 21 and 26, as well as those earn either really low, below 12,500 and those who earns extremely high, above 100,000 annually, are more receptive to coupon offers. I am not sure if this is a result of effective marketing or just the nature of variables but this for sure implying an establishment and implementation of a market stratigies to capitalize the profit from those two groups as an example.
